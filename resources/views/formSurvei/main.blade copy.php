				...
				<div class="d-flex flex-column flex-lg-row-fluid py-10">
					...
					<div class="d-flex flex-center flex-column flex-column-fluid">
						...
						<div class="w-lg-650px w-xl-700px p-10 p-lg-15 mx-auto">
							<!--begin::Form-->
							<form class="my-auto pb-5" novalidate="novalidate" id="kt_stepper_example_basic">
								<!--begin::Step 1-->
								<div class="current" data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="mb-10 fv-row">
											...
											<!--end::Label-->
											<!--begin::Input-->
											<input type="text" class="form-control form-control-lg form-control-solid" name="survei_nik" placeholder="321706XXXX" value="" min="16" max="16" />
											<!--end::Input-->
										</div>
										<!--end::Input group-->
										...
										<div class="mb-10 fv-row">
											...
											<!--end::Label-->
											<!--begin::Input-->
											<input type="text" class="form-control form-control-lg form-control-solid" name="survei_nama" placeholder="" value="" min="2" max="50" />
											<!--end::Input-->
										</div>
										<!--end::Input group-->
										...
										<div class="mb-10 fv-row">
											...
											<!--end::Label-->
											<!--begin::Input-->
											<input type="text" class="form-control form-control-lg form-control-solid" name="survei_telp" placeholder="0857XXXXXXXX" value="" min="10" max="15" />
											<!--end::Input-->
										</div>
										<!--end::Input group-->
								...
								<div class="" data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="fv-row mb-10">
											...
											<!--end::Label-->
											<!--begin::Input-->
											<select name="survei_prov_kode" class="form-select form-select-lg form-select-solid" data-control="select2" data-placeholder="Select..." data-allow-clear="true">
												<option></option>
										...
										<div class="fv-row mb-10">
											...
											<!--end::Label-->
											<!--begin::Input-->
											<select name="survei_kab_kode" class="form-select form-select-lg form-select-solid" data-control="select2" data-placeholder="Select..." data-allow-clear="true">
												<option></option>
											</select>
											<!--end::Input-->
										</div>
										...
										<div class="fv-row mb-10">
											...
											<!--end::Label-->
											<!--begin::Input-->
											<select name="survei_kec_kode" class="form-select form-select-lg form-select-solid" data-control="select2" data-placeholder="Select..." data-allow-clear="true">
												<option></option>
											</select>
											<!--end::Input-->
										</div>
										...
										<div class="fv-row mb-10">
											...
											<!--end::Label-->
											<!--begin::Input-->
											<select name="survei_kel_kode" class="form-select form-select-lg form-select-solid" data-control="select2" data-placeholder="Select..." data-allow-clear="true">
												<option></option>
											</select>
											<!--end::Input-->
										</div>
